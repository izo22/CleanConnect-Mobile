...
describe('getProxyForUrl', function() {
  ...
  describe('no_proxy=[::1],[::2]:80,10.0.0.6,10.0.0.6:80 (IP addresses)',
      function() {
    var env = {};
    env.HTTP_PROXY = 'http://proxy';

    env.NO_PROXY = '[::1],[::2]:80,10.0.0.6,10.0.0.6:80';
    ...
    testProxyUrl(env, '', 'http://10.0.0.6/');
    testProxyUrl(env, '', 'http://10.0.0.6:80/');
    testProxyUrl(env, '', 'http://10.0.0.6:1337/');

    testProxyUrl(env, '', 'http://10.0.0.6/');
    testProxyUrl(env, '', 'http://10.0.0.6:80/');
    testProxyUrl(env, 'http://proxy', 'http://10.0.0.6:1337/');
  });
